...
import { SeasonImageUpload } from "./SeasonsLambdaInvokes/SeasonImageUpload";
...
export function CinemaSeason({
  ...
  return (
    <section className={`cinema-season${open ? " expanded" : ""}`}>
      ...
      >
        ...
        <div className="season-header-right">
          <span className="season-film-count">
            {filmEntries.length} film{filmEntries.length !== 1 ? "s" : ""}
          </span>
          <span className={`season-chevron${open ? " open" : ""}`}>
            &#9662;
          </span>
        </div>
      </div>
      ...
      {open && (
        <div className="season-body">
          <div className="season-body-toolbar">
          ...
          <div className="season-section">
            ...
            <SeasonImageUpload
              cinemaId={cinemaId}
              seasonKey={seasonKey}
              existingImages={info.season_images}
            />
          </div>
